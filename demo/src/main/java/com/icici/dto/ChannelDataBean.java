...
//  private String DEPTMSGID;
    ...
    public ChannelDataBean(String msg_id, String dept_id, String app_id, String mobile_no, String msg_text,
    ...
    public String toString() {
        return "ChannelDataBean [msg_id=" + msg_id + ", dept_id=" + dept_id + ", app_id=" + app_id + ", mobile_no="
